...
4. Use `capture_answer` to quick-save useful Q&A pairs.
5. Use `ingest_source` to ingest URLs or raw text into the knowledge base.
6. Use `build_graph` to generate an interactive knowledge graph visualization.
